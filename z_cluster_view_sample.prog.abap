...
REPORT z_cluster_view_sample.

TABLES:
    scarr
    .

DATA: og_cluster_view TYPE REF TO zcl_cluster_view
      .
...
FORM f_executar .
  DATA:
          tl_key_data_1  TYPE zcl_cluster_view=>y_t_key_item,
          tl_scarr       TYPE STANDARD TABLE OF scarr,

          wl_key_nivel    TYPE zcl_cluster_view=>y_key_nivel,
          wl_key_data_1 LIKE LINE OF tl_key_data_1,

          ol_x_cluster TYPE REF TO zcx_cluster_view,
  ...
  TRY.
    ...
    CATCH zcx_cluster_view INTO ol_x_cluster.
